...
import { TaskDto, TaskCreateDto, TaskStatusUpdateDto, TaskUpdateDto } from '../../models/task.model';
...
export class TaskService {
  ...
  updateTask(taskId: number, dto: TaskUpdateDto): Observable<void> {
    return this.http.put<void>(`${this.apiUrl}/tasks/${taskId}`, dto);
  }
